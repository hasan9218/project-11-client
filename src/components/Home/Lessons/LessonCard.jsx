...
const LessonCard = ({ lesson }) => {
    ...
    return (
        < >
            <div className={`relative card bg-base-100 shadow-xl border p-4 transition ${(lesson.accessLevel === "premium" && !userData?.isPremium) ? "opacity-10 blur-[2px] pointer-events-none" : ""
                    }`}
            >
